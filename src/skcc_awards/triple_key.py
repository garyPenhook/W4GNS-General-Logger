...
Rules:
- Contact 100+ unique SKCC members using Straight Key
- Contact 100+ unique SKCC members using Bug
- Contact 100+ unique SKCC members using Sideswiper
- CW mode exclusively
...
- Same member can count for multiple key types
...
class TripleKeyAward(SKCCAwardBase):
    ...
    def calculate_progress(self, contacts: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        Tracks unique SKCC members contacted with each key type separately.
        ...
        Returns:
            {
                ...
                'total_contacts': int,             # Sum of all 3 key type counts
        ...
        # Total contacts is sum of all three
        total_contacts = straight_count + bug_count + sideswiper_count
        ...
        # For endorsement calculation, use total contacts
        endorsement_level = get_endorsement_level(total_contacts, TRIPLE_KEY_ENDORSEMENTS)
        next_level = get_next_endorsement_threshold(total_contacts, TRIPLE_KEY_ENDORSEMENTS)
    ...
    def get_requirements(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'description': 'Contact 100+ members with each of 3 mechanical key types',
            'base_requirement': '100 unique members per key type (300 total)',
            ...
            'special_rules': [
                ...
                'Endorsements based on total contacts across all key types'
            ],
    ...
    def get_endorsements(self) -> List[Dict[str, Any]]:
        ...
        """
        return [
            {'level': 300, 'description': 'Triple Key', 'contacts_needed': '100 per key type'},
            {'level': 600, 'description': 'Triple Key x2', 'contacts_needed': '200 per key type'},
            {'level': 900, 'description': 'Triple Key x3', 'contacts_needed': '300 per key type'},
            {'level': 1500, 'description': 'Triple Key x5', 'contacts_needed': '500 per key type'},
            {'level': 3000, 'description': 'Triple Key x10', 'contacts_needed': '1000 per key type'},
        ]
